...
module.exports.decrypt = function (ciphertext, keyBase64) {
...
module.exports.encrypt = function (plaintext, keyBase64) {
  var key = CryptoJS.enc.Base64.parse(keyBase64)
...
module.exports.deriveKey = function (password, saltBase64) {
...
module.exports.createSaltBase64 = function () {
